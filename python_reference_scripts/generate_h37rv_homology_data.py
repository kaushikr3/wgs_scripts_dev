...
def add_h37rv_homolog_data(df: pd.DataFrame, 
    ...
    gene_details = pd.read_csv("~/wgs/Reference/annotation_csvs/AL123456_gene_details.csv")
...
def main():
    ...
    RV_selected_features = pd.read_csv("~wgs/Reference/annotation_csvs/AL123456_selected_features.csv")
