...
def main():
    ...
    my_parser.add_argument('-strain', required=True,
                           dest='strain', choices={'H37RvCO', 'HN878', 'Erdman'}, type=str)
    ...
    #pdim_range = pd.read_csv('./../../../Scripts/metadata/PDIM_locations.csv')
    pdim_range = pd.read_csv('../wgs_scripts/metadata/PDIM_locations.csv')
    ...
    selected_features = pd.read_csv(
        f"../wgs_scripts/metadata/PDIM_{args.strain}_features.csv")
...
def extract_snp_details(csv, start, end):
    ...
    snp_pdim = snp_pdim[['Strain', '#Mutations', 'Ref_genome', 'Ref_pos',
